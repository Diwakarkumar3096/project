...
subtraction=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),text="-",bg="powder blue",
...
multiple=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),text="*",bg="powder blue",
...
btnc=Button(cal,padx=16,pady=16,bd=8,fg='black',font=('arial',20,'bold'),text="c",bg="powder blue",
...
Division=Button(cal,padx=16,pady=16,bd=8,fg='black',font=('arial',20,'bold'),text="/",bg="powder blue",
